...
>
> La maintenance de ce projet est déplacée vers Codeberg sur https://codeberg.org/PatrickPremartin/Video-Splitter
>
...
> [!NOTE]
> Pour ouvrir ou intervenir sur un ticket de ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/Video-Splitter/issues
> Pour faire un PULL REQUEST sur ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/Video-Splitter/pulls
> Pour toute autre information ou me contacter vous pouvez aussi consulter le site Internet du projet sur https://videosplitter.olfsoftware.fr ou son devlog sur https://videosplitter.olfsoftware.fr/dev-corner.html
...
Consultez [le site de Video Splitter](https://videosplitter.olfsoftware.fr) pour télécharger sa version compilée, en savoir plus sur son fonctionnement, accéder à des vidéos et articles, connaître les différentes versions disponibles et leurs fonctionnalités, contacter le support utilisateurs...
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/Video-Splitter/issues) pour que je teste et tente de corriger ou fournir un contournement.
...
Si cette licence ne convient pas à vos besoins (notamment pour un projet commercial) je propose aussi [des licences classiques pour les développeurs et les entreprises](https://videosplitter.olfsoftware.fr).
